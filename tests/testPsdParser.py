...
class TestPsdParser(unittest.TestCase) :
    def test_file(self) :
        ...
        for image in images :
            ...
            self.assertTrue(flag, 'Function \'psd_to_images\' returns another images, then in test file. merge_group=True')
            flag = False
        ...
        for image in images :
            ...
            self.assertTrue(flag, 'Function \'psd_to_images\' returns another images, then in test file. merge_group=False')
            flag = False
